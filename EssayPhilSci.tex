...
There is \textit{such} vagueness in the concept of a law that it fails to refer. (Mumford, 2004, 127.)
 \end{displayquote} 
...
since that requires laws to govern what is in effect internal to them. (\textit{Ibid.}) \end{displayquote}
