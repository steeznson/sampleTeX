...
The former endorse a weaker view. Some assert that only some properties are dispositions, while others assert that every property has only a dispositonal element. 
...
Identifying a natural kind allows us to infer information about other members of said kind, as what can be said of one member can be said of all.\par
...
They think that at most we can say that events are merely constantly conjoint in patterns, as we can never know exactly what is causing events to take place. 
...
Mumford's second point targets the semantics of the word `law.' He is noting that there are a variety of terms that play the same functional role as what most would consider a law. 
